...
export class CultureInfo {
    ...
    //
    public _cultureData: CultureData;

    // public _isInherited: boolean;
    ...
    public static readonly LOCALE_NEUTRAL = 0x0000;
    private static readonly LOCALE_USER_DEFAULT = 0x0400;
    private static readonly LOCALE_SYSTEM_DEFAULT = 0x0800;
    public static readonly LOCALE_CUSTOM_UNSPECIFIED = 0x1000;
    public static readonly LOCALE_CUSTOM_DEFAULT = 0x0c00;
    public static readonly LOCALE_INVARIANT = 0x007F;
    ...
    private static GetCultureNotSupportedExceptionMessage(): string {
        return "Argument_CultureNotSupported"
    }
    ...
    public constructor(name: string, useUserOverride: boolean = true) {
        Throw.ThrowIfNull(name);

        // // Get our data providing record
        this._cultureData = CultureData.GetCultureData(name, useUserOverride) ??
            Throw.CultureNotFoundException('name', name, CultureInfo.GetCultureNotSupportedExceptionMessage());
    ...
    //         /// </summary>
    //         public CultureInfo(string cultureName, string textAndCompareCultureName)
    //         {
    ...
    //         public static bool VerifyCultureName(string cultureName, bool throwException)
    //         {
    ...
    //         public static bool VerifyCultureName(CultureInfo culture, bool throwException)
    //         {
    ...
    //         public static CultureInfo UserDefaultUICulture => s_userDefaultUICulture ?? InitializeUserDefaultUICulture();
    ...
    //         /// </summary>
            public  get Name(): string {
                this._nonSortName =  this._cultureData.Name ?? "";
                return this._nonSortName;
            } 

    //         /// <summary>
    //         /// This one has the sort information (ie: de-DE_phoneb)
    //         /// </summary>
    //         public string SortName => _sortName ??= _cultureData.SortName;
    ...
    //         /// </summary>
    //         public string? InteropName => _cultureData.InteropName;
    ...
    //         /// </summary>
    //         public bool HasInvariantCultureName => Name == InvariantCulture.Name;

    //         /// <summary>
    //         /// Gets a cached copy of the specified culture from an public
    ...
    //             // we have public state representing the sort (so someone would get the wrong cached version).
