import { ISimpleTypeProvider } from "./ISimpleTypeProvider"
import { IConstructedTypeProvider } from "./IConstructedTypeProvider"
import { MethodSignature } from "System.Reflection.Metadata/Signature/MethodSignature"

export interface ISignatureTypeProvider<TType, TGenericContext> extends ISimpleTypeProvider<TType>, IConstructedTypeProvider<TType> {
    /// <summary>
    /// Gets the a type symbol for the function pointer type of the given method signature.
    /// </summary>
    GetFunctionPointerType(signature: MethodSignature<TType>): TType
