...
/// </summary>
/// <exception cref="ArgumentNullException"><paramref name="reader"/> is undefined.</exception>

import { Throw } from "System";
import { TableIndex, MetadataTokens } from "System.Reflection.Metadata.Ecma335";
...
export function GetTableRowCount(reader: MetadataReader, tableIndex: TableIndex) {
    if (reader == undefined) {
        Throw.ArgumentNull('reader');
    }

    if (tableIndex >= MetadataTokens.TableCount) {
        Throw.TableIndexOutOfRange();
    }

    return reader.TableRowCounts[tableIndex];
}
...
//         /// <exception cref="ArgumentNullException"><paramref name="reader"/> is undefined.</exception>
//         /// <exception cref="ArgumentOutOfRangeException"><paramref name="tableIndex"/> is not a valid table index.</exception>
//         export function  GetTableRowSize(this MetadataReader reader, TableIndex tableIndex)
//         {
//             if (reader is undefined)
//             {
...
//         export function  GetHeapSize(this MetadataReader reader, HeapIndex heapIndex)
//         {
//             if (reader is undefined)
//             {
//                 Throw.ArgumentNull(nameof(reader));
