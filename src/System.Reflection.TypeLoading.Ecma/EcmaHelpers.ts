...
import { AssemblyReferenceHandle, MetadataReader, StringHandle } from "System.Reflection.Metadata";
import { RoAssemblyName } from "System.Reflection.TypeLoading";

/// <summary>
/// Returns a RoAssemblyName corresponding to the assembly reference.
/// </summary>
export function ToRoAssemblyName(h: AssemblyReferenceHandle, reader: MetadataReader): RoAssemblyName {

        //     const a = reader.GetAssemblyReference(h);
        //     const name = a.Name.GetString(reader);
...
export function StringHandleEqualsFromUint8(h: StringHandle, a: Uint8Array, reader: MetadataReader): boolean {
        return h.GetString(reader) == Buffer.from(a).toString("utf8");
}