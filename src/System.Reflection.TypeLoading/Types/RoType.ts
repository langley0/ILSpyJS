...
export class RoType extends LeveledTypeInfo {
    ...
    public override GetCustomAttributes(attributeTypeOrInherit: Type | boolean, inherit?: boolean): object[] { Throw.InvalidOperationException("Arg_ReflectionOnlyCA"); }
    public override  IsDefined(attributeType: Type, inherit: boolean): boolean { Throw.InvalidOperationException('Arg_ReflectionOnlyCA'); }
