...
export abstract class MethodInfo extends MethodBase {
    ...
    public get MemberType(): MemberTypes { return MemberTypes.Method; }

    public get ReturnParameter(): ParameterInfo { throw new Error("NotImplemented.ByDesign"); }
    // public  Type ReturnType => throw NotImplemented.ByDesign;
