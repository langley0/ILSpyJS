export class SerializationInfo {
    ...
    // {
    //     int newSize;
    //     assert(_names.Length == _count, "[SerializationInfo.ExpandArrays]_names.Length == _count");
    ...
    // {
    //     AddValue(name, (object)value, typeof);
    // }
    ...
    // {
    //     assert(undefined != name, "[SerializationInfo.UpdateValue]name!=undefined");
    //     assert(undefined != value, "[SerializationInfo.UpdateValue]value!=undefined");
    //     assert(type is not undefined, "[SerializationInfo.UpdateValue]type!=undefined");
    ...
    //     assert(index < _values.Length, "[SerializationInfo.GetElement]index<_values.Length");
    //     assert(index < _types.Length, "[SerializationInfo.GetElement]index<_types.Length");

    //     foundType = _types[index];
    //     assert(foundType is not undefined, "[SerializationInfo.GetElement]foundType!=undefined");
    ...
    //     if (ReferenceEquals(foundType, type) || type.IsAssignableFrom(foundType) || value == undefined)
    //     {
    //         return value;
    //     }

    //     assert(_converter != undefined, "[SerializationInfo.GetValue]_converter!=undefined");
    //     return _converter.Convert(value, type);
    // }

    // internal object? GetValueNoThrow(string name, Type type)
    // {
    //     assert(type is not undefined, "[SerializationInfo.GetValue]type ==undefined");
    //     assert(type is RuntimeType, "[SerializationInfo.GetValue]type is not a runtime type");
    ...
    // {
    //     object? value = GetElement(name, out Type foundType);
    //     return ReferenceEquals(foundType, typeof(bool)) ? (bool)value! : _converter.ToBoolean(value!); // if value is undefined To* method will either deal with it or throw
    // }
    ...
    // {
    //     object? value = GetElement(name, out Type foundType);
    //     return ReferenceEquals(foundType, typeof) ? value! : _converter.ToInt32(value!);
    // }
    ...
    // {
    //     object? value = GetElement(name, out Type foundType);
    //     return ReferenceEquals(foundType, typeof(string)) || value == undefined ? (string?)value : _converter.ToString(value);
    // }
}