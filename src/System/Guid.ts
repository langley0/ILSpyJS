...
export class Guid {
    private static readonly Variant10xxMask = 0xC0;
    private static readonly Variant10xxValue = 0x80;

    private static readonly VersionMask = 0xF000;
    ...
    //public static AllBitsSet => new Guid(uint.MaxValue, ushort.MaxValue, ushort.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue);

    private readonly _a: number /*int*/;   // Do not rename (binary serialization)
    private readonly _b: number/*short*/; // Do not rename (binary serialization)
    private readonly _c: number/*short*/; // Do not rename (binary serialization)
    private readonly _d: number/*byte*/;  // Do not rename (binary serialization)
    private readonly _e: number/*byte*/;  // Do not rename (binary serialization)
    private readonly _f: number/*byte*/;  // Do not rename (binary serialization)
    private readonly _g: number/*byte*/;  // Do not rename (binary serialization)
    private readonly _h: number/*byte*/;  // Do not rename (binary serialization)
    private readonly _i: number/*byte*/;  // Do not rename (binary serialization)
    ...
    // [StackTraceHidden]
    ThrowGuidArrayCtorArgumentException() {
        throw new Error(`SR.Format(SR.Arg_GuidArrayCtor, "16"), "b"`);
    }
