...
// export class RuntimeType extends TypeInfo {
//     // private MethodTable* _pUnderlyingEEType;
//     // private IntPtr _runtimeTypeInfoHandle;

//     // public constructor(MethodTable* pEEType)
//     // {
//     //     this._pUnderlyingEEType = pEEType;
//     // }
...
//     // {
//     //     Debug.Assert(_pUnderlyingEEType == undefined);
...
//     // public override GetEnumName( value: object): string | undefined
//     // {
//     //     Throw.ThrowIfNull(value);

//     //     let rawValue: number | undefined = Enum.TryGetUnboxedValueOfEnumOrInteger(value);
//     //     if (rawValue == undefined)
//     //         Throw.ArgumentException("Arg_MustBeEnumBaseTypeOrEnum","value");
...
//     //         return Enum.GetName(this, rawValue) != undefined;
//     //     }
//     // }
...
//     //     MethodTable* pEEType = _pUnderlyingEEType;
//     //     if (pEEType != undefined)
//     //         return pEEType->IsParameterizedType ? GetTypeFromMethodTable(pEEType->RelatedParameterType) : undefined;
...
//     //                 return (pBaseType != undefined) ? GetTypeFromMethodTable(pBaseType) : undefined;
//     //             }
...
//     // {
//     //     MethodTable* pEEType = _pUnderlyingEEType;
//     //     if (pEEType != undefined && !pEEType->IsGenericTypeDefinition)
//     //     {
...
//     //     get
//     //     {
//     //         if (_pUnderlyingEEType != undefined)
//     //             return false;
...
//     //         return false;  // Desktop compat: If typeInfo is undefined, or implemented by a different Reflection implementation, return "false."

//     //     if (fromRuntimeType._pUnderlyingEEType != undefined && _pUnderlyingEEType != undefined)
//     //     {
...
//     //     return RuntimeImports.IsInstanceOf(pEEType, o) != undefined;
//     // }
...
//     //     => typeInfo != undefined && IsAssignableFrom(typeInfo.AsType());
...
//     {
//             return this.GetRuntimeTypeInfo().Name;
//     }

//     public override get Namespace(): string | undefined
//     {
//             return this.GetRuntimeTypeInfo().Namespace;
//     }
