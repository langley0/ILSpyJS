...
//      const s_peImages = new Map<Uint8Array, number>();

//             // function GetMetadataReader(byte[] peImage, bool isModule = false, MetadataReaderOptions options = MetadataReaderOptions.Default, MetadataStringDecoder decoder = null): MetadataReader
//             // {
//             //     int _;
...
//             /// </summary>
//             // [Fact]
//             public ValidateAssemblyTableExe()
//             {
//                 var reader = GetMetadataReader(NetModule.AppCS);
